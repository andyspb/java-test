...
/**
 * Java program to demonstrate How to use notify and notifyAll method in Java and How to notify and
 * notifyAll method notifies thread, which thread gets woke up etc.
 */
public class NotificationTest {
  ...
  public static void main(String args[]) throws InterruptedException {
    ...
    Thread t3 = new Thread(waitTask, "WaitThread_3"); // will wait
    Thread t4 = new Thread(notifyTask, "NotifyThread_1"); // will notify
